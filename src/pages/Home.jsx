...
const Home = () => {
  ...
  return (
    <div>
      <div>
        <Header as="h1">ADI Inventory - Medium Assurance</Header>
        ...
        {!authState.isAuthenticated && (
          <div>
            <p>
              <span>This applications is a Medium Assurance Application</span>
            </p>
            <p>
              When you click the login button below, you will be redirected to
              the login page on your Okta org.
            </p>
            <strong>Authentication should only require a Password.</strong>
            <br />
            <br />
